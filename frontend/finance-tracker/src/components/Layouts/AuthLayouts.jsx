...
const AuthLayouts = ({ children }) => {
  return <div className="flex">
    ...
    <div className="hidden md:block w-[40vw] h-screen bg-[#F8F8F9] bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
        ...
        <div className="grid grid-cols-1 z-20">
          <StatsInfoCard
            ...
            label="Track your total Income and Expenses"
            value="69,000"
            color="bg-primary"
          />
        </div>
        ...
        <img 
          src={CARD_2} 
          className="w-64 lg:w-[90%] absolute bottom-10 shadow-blue-400/15 right-10" 
        />
    </div>
  </div>;
}
